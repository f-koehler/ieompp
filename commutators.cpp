...
{
    static const auto kinetic_term1 = ieompp::make_term(
...
void commutate_H_int(const Term& term)
{
    static const auto interaction_term1 = ieompp::make_term(
        ieompp::symbolic::make_prefactor(1.), {ieompp::make_creator(Index(1), Spin(1, u8"↑")),
                                               ieompp::make_annihilator(Index(1), Spin(1, u8"↑")),
                                               ieompp::make_creator(Index(1), Spin(1, u8"↓")),
                                               ieompp::make_annihilator(Index(1), Spin(1, u8"↓"))});
    static const auto interaction_term2 =
        ieompp::make_term(ieompp::symbolic::make_prefactor(-.5),
                          {ieompp::make_creator(Index(1), Spin(1, u8"↑")),
                           ieompp::make_annihilator(Index(1), Spin(1, u8"↑"))});
    static const auto interaction_term3 =
        ieompp::make_term(ieompp::symbolic::make_prefactor(-.5),
                          {ieompp::make_creator(Index(1), Spin(1, u8"↓")),
                           ieompp::make_annihilator(Index(1), Spin(1, u8"↓"))});
...
int main()
{
    auto term1 = ieompp::make_term(ieompp::symbolic::make_prefactor(1.),
                                   {ieompp::make_creator(Index(1, "x"), Spin(1, u8"↑"))});
    auto term2 = ieompp::make_term(ieompp::symbolic::make_prefactor(1.),
                                   {ieompp::make_creator(Index(1, "x"), Spin(1, u8"↑")),
                                    ieompp::make_creator(Index(1, "x"), Spin(1, u8"↓")),
                                    ieompp::make_annihilator(Index(1, "x"), Spin(1, u8"↓"))});
