...
{
    const std::string program_name("hubbard_kinetic_matrix_1d_real");
    ...
    description.add_options()
        ...
        ("out", po::value<string>()->default_value("kinetic_matrix_1d_real.txt"), "output file")
        ("log", po::value<string>()->default_value("kinetic_matrix_1d_real.log"), "log file");
