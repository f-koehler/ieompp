...
namespace ieompp
{
    namespace hubbard
    {
        ...
        template <typename Matrix, typename Basis, typename Prefactor>
        void init_interaction_matrix(Matrix& matrix, const Basis& basis, const Prefactor& U = 1.);

        template <typename Matrix, typename Basis, typename Lattice, typename Prefactor>
        void init_matrix(Matrix& matrix, const Basis& basis, const Lattice& lattice,
